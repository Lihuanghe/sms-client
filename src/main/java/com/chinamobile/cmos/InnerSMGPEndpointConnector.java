...
import com.zx.sms.connect.manager.smgp.SMGPClientEndpointConnector;
...
class InnerSMGPEndpointConnector extends SMGPClientEndpointConnector   implements LoginResponseWaiter{
	...
	public InnerSMGPEndpointConnector(SMGPClientEndpointEntity e) {
		super(e);
	}
	...
	protected void doinitPipeLine(ChannelPipeline pipeline) {
		...
		SMGPSessionLoginManager handler =(SMGPSessionLoginManager) pipeline.get("sessionLoginManager");
		pipeline.replace(handler, "sessionLoginManager", new SMGPSessionLoginManager(getEndpointEntity()) {
